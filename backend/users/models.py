...
#     def __str__(self):
#         return f"{self.user.username}'s appointment with {self.doctor_slot.doctor.name} on {self.doctor_slot.date} - {self.doctor_slot.start_time} to {self.doctor_slot.end_time}"
